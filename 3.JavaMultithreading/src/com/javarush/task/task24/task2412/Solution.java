                ...
                if (result == 0) {
                    ...
                    if (result == 0) {
                        ...
                        if (stock1.containsKey("last"))
                            stock1_value = (double) stock1.get("last") - (double) stock1.get("open");
                        else stock1_value = (double) stock1.get("change");

                        if (stock2.containsKey("last"))
                            stock2_value = (double) stock2.get("last") - (double) stock2.get("open");
                        else stock2_value = (double) stock2.get("change");
                        return Double.compare(stock2_value, stock1_value);
                    }
                }
                return result;
            }
